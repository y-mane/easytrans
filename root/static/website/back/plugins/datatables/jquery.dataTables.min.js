...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Premier",sLast:"Dernier",sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"Aucunes Données Disponibles",sInfo:"Affichage _START_ à _END_ sur _TOTAL_ entrées",sInfoEmpty:"Affichage 0 à 0 sur 0 entrées",
sInfoFiltered:"(Filtre sur _MAX_ entrées)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Affichage _MENU_ entrées",sLoadingRecords:"Chargement...",sProcessing:"Traitement...",sSearch:"Recherche:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun Enregistrement trouvé"},oSearch:g.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
